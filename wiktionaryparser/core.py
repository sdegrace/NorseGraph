...
RELATIONS = [
    ...
    "coordinate terms", "alternate forms", "decendants"
]
...
class WiktionaryParser(object):
    ...
    def get_id_list(self, contents, content_type):
        ...
        elif content_type == 'definitions' or content_type == 'declensions':
    ...
    def get_word_data(self, language):
        ...
        word_data = {
            ...
            'declensions': self.parse_declensions(word_contents),
    ...
    def parse_declensions(self, word_contents):
        declension_id_list = self.get_id_list(word_contents, 'declensions')
        declension_list = []
